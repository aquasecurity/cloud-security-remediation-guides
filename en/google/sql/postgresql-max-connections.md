...
| **Recommended Action** | Ensure that all PostgreSQL database instances have max_connections flag and it value is set. |
...
5. To set a flag that has not been set on the instance before, click Add item, choose the `max_connections` flag from the drop-down menu, and set its value.
