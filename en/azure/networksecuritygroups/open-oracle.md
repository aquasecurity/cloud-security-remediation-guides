...
2. Click the search bar at the top and search for Network security groups. </br> <img src="/resources/azure/networksecuritygroups/open-oracle/step2.png"/>
...
6. If the "Oracle" for port 1521 with the protocol "TCP" is showing as "Allow" under "Actions" column for all "Source" and "Destination" then the selected  "Network security group" has TCP port 1521 for Oracle open to the public. </br> <img src="/resources/azure/networksecuritygroups/open-oracle/step6.png"/>
...
11. Repeat step number 8 - 10 to restrict TCP port 1521 for Oracle to known IP addresses. </br>
