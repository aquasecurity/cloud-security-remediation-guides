...
6. Click on "Add a frontend IP configuration" at the top to add the IP address . </br> <img src="/resources/azure/loadbalancer/lb-public-ip/step6.png"/>
...
9. Add the IP configuration and then click on the 'Next: Backend Pools' and fill the options as per requirement and create the load balancer. <img src="/resources/azure/loadbalancer/lb-public-ip/step9.png"/>
