...
15. Provide the other necessary details for the new Instance and under the "Configuration Instance" choose the newly created "VPC" instead of default VPC.</br> <img src="/resources/aws/ec2/default-vpc-in-use/step15.png"/>
16. Click on the "Launch" button once reviewing the necessary configuration to launch the new Instance. Once Instance is in healthy state remove the older instance which is using the default VPC.</br>
