...
2. In the left navigation panel, scroll down and choose Auto Scaling Group(s) option and select the ASG(s) that needs to be modified.[![Step 2](https://github.com/shuklaalok87/security-remediation-guides/resources/aws/autoscaling/step2.png "Step 2 - ASG")](https://github.com/shuklaalok87/security-remediation-guides/resources/aws/autoscaling/step2.png)  
3. Select the Details tab and check the Availability Zone(s). If Availability Zone(s) value is set to a single availability zone (e.g. us-east-1b), it cannot launch instances to multiple Availabilty Zone(s) hence if one Availability Zone becomes unavailable, Amazon EC2 Auto Scaling cannot launch instances in another one to atone.[![Step 3](https://github.com/shuklaalok87/security-remediation-guides/resources/aws/autoscaling/Step3.png "Step 3 - Details")]  
