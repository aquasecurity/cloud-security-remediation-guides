...
2. In the left navigation panel, scroll down and choose ASG(s) option and select the ASG(s) that needs to be modified. ![Step 2](/resources/aws/autoscaling/step2.png "Step 2 - ASG")  
