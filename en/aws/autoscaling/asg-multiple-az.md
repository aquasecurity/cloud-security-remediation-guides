...
2. In the left navigation panel, scroll down and choose Auto Scaling Group(s) option and select the ASG(s) that needs to be modified.[![Step 2](https://github.com/shuklaalok87/security-remediation-guides/resources/aws/autoscaling/step2.png "Step 2 - ASG")](https://github.com)  
